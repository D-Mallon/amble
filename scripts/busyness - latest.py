...
# data_path = r"C:\Users\corma\COMP47360" #dataframe data
...
#For the moment dummy weather variables
for j in range(24):
    temp.append(15)
    hum.append(10)
    wind.append(10)
...
print(df[['Pickle Busyness Predicted','Hour', 'Temperature','TImestamp','Day_Monday','Day_Sunday','Day_Tuesday','Day_Wednesday','PULocationID_4','PULocationID_13']].head(60))
